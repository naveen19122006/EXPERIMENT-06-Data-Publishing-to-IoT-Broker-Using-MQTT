...
broker = "bcdd46c369f84c45be7202fed1aaddf1.s1.eu.hivemq.cloud"
port = 8883
topic = "iot1/demo/sensor"
username = "hivemq.webclient.1762398477937"
password = "Q4Dk1l6Hh>Map<7:Ko#Z"
...
client.publish(topic, "Hello Naveen Kumar")
client.loop(2)
client.disconnect()
```
